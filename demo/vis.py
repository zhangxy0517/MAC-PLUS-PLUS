...
def visualize(path):
    def change_background_to_black(vis):
        ...
        return False
    raw_src_pcd = o3d.io.read_point_cloud(os.path.join(path, '../src.ply'))
    raw_tgt_pcd = o3d.io.read_point_cloud(os.path.join(path, '../tgt.ply'))
    src_kpts = o3d.io.read_point_cloud(os.path.join(path, '../src.pcd'))
    tgt_kpts = o3d.io.read_point_cloud(os.path.join(path, '../tgt.pcd'))
